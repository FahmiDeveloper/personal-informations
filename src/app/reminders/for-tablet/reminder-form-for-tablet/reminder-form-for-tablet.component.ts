...
@Component({
  selector: 'reminder-form-for-tablet',
  templateUrl: './reminder-form-for-tablet.component.html',
  styleUrls: ['./reminder-form-for-tablet.scss']
})

export class ReminderFormForTabletComponent implements OnInit {
  ...
  constructor(
    ...
    public dialogRef: MatDialogRef<ReminderFormForTabletComponent>
  ) {}
