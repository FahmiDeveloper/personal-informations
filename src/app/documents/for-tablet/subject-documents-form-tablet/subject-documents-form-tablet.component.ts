...
@Component({
  selector: 'subject-documents-form-tablet',
  templateUrl: './subject-documents-form-tablet.component.html',
  styleUrls: ['./subject-documents-form-tablet.scss']
})

export class SubjectDocumentsFormTabletComponent implements OnInit {
  ...
  constructor(
    ...
    public dialogRef: MatDialogRef<SubjectDocumentsFormTabletComponent>
  ) {}
